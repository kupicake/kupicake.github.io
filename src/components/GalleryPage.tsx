  ...
  return (
    ...
    >
      ...
      <div className="bg-[#faf9f5] col-start-2 col-end-3 row-start-1 pt-16 lg:pt-20 pb-0 flex flex-col justify-between items-start w-full min-h-screen lg:h-screen transition-colors duration-500">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-[1px] bg-[#E5E2DC] border-t border-b border-[#E5E2DC] shrink-0 lg:shrink lg:flex-1 font-sans">
          {/* Box 1: Status & Info */}
          <div className="bg-[#faf9f5] hover:bg-white transition-colors duration-500 p-5 md:p-6 lg:p-8 flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-[#1a1a1a] font-normal text-xl md:text-2xl lg:text-[28px] leading-tight mb-4 font-sans">
          ...
          <div className="bg-[#faf9f5] hover:bg-white transition-colors duration-500 p-5 md:p-6 lg:p-8 flex flex-col justify-between group/contact-box relative overflow-hidden font-sans">
            <div>
              <span className="text-[#8a8a85] font-mono text-[10px] md:text-xs uppercase tracking-wider block mb-3">
                02 // DIRECT INQUIRY
              </span>
